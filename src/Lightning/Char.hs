...
newline :: Token ~ Char => Parser Token
newline = char '\n'
{-# INLINE newline #-}
...
char :: Token ~ Char => Token -> Parser Token
char = single
{-# INLINE char #-}
...
string :: Token ~ Char => Tokens -> Parser Tokens
string = chunk
{-# INLINE string #-}
