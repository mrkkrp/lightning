...
import qualified Lightning.Char as C
...
decimal :: (Token ~ Char, Integral a) => Parser a
...
float :: (Token ~ Char, RealFloat a) => Parser a
float = do
  c' <- decimal_
  Sci.toRealFloat <$>
